...
const AgentCard: React.FC<AgentCardProps> = ({ agent }) => {
  ...
  return (
    <>
      <div className="group bg-white rounded-[2rem] border border-gray-100 p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 w-full max-w-5xl mx-auto overflow-hidden">
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8">
          ...
          {/* Right Side: Content */}
          <div className="flex-1 flex flex-col pt-2 min-w-0 overflow-hidden">
            <div className="mb-6">
            ...
            <div className="space-y-6 overflow-hidden">
              {/* Function Section */}
              <div>
                <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wide mb-2 break-words">
                  Qual a função da {agent.name}?
                </h4>
                <p className="text-[15px] text-gray-700 leading-relaxed font-medium break-words">
                  {agent.description}
                </p>
              </div>
              ...
              <div>
                <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wide mb-3 break-words">
                  Principais tarefas da {agent.name}
                </h4>
            ...
            {/* Action Buttons (Stacked for better visibility) */}
            <div className="mt-8 flex flex-col gap-3">
              <button
                onClick={() => setShowModal(true)}
                className="w-full cursor-pointer items-center justify-center rounded-2xl py-3.5 px-4 bg-[#22c55e] hover:bg-green-600 transition-all text-white text-sm font-bold shadow-lg shadow-green-500/20 active:scale-95 flex gap-2"
              >
              ...
              <a
                ...
                className="w-full flex cursor-pointer items-center justify-center rounded-2xl py-3.5 px-4 bg-primary hover:bg-primary-dark transition-all text-white text-sm font-bold shadow-lg shadow-primary/20 active:scale-95 gap-2"
              >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              <div className="space-y-10">
                {/* Description */}
                <div>
                  <h4 className="text-[12px] font-bold text-gray-400 uppercase tracking-wide mb-4 break-words">
                    Qual a função da {agent.name}?
                  </h4>
                ...
                {/* Detailed Tasks */}
                <div>
                  <h4 className="text-[12px] font-bold text-gray-400 uppercase tracking-wide mb-6 break-words">
                    Principais tarefas da {agent.name}
                  </h4>
