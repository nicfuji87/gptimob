          ...
          <div className="flex flex-col items-center gap-6 max-w-4xl">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <a
                ...
                className="flex min-w-[240px] cursor-pointer items-center justify-center gap-3 rounded-full h-14 px-8 bg-[#25D366] hover:bg-[#20bd5a] text-white text-base font-bold transition-all hover:scale-105 shadow-xl shadow-green-500/20 active:scale-95"
              >
